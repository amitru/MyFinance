<%@page import="com.amitru.mystockalert.login.GoogleAuthHelper"%>
...
<body>
	...
	<div class="readme">
		...
		<ol>
			...
			<li>Browse to: <a href="http://amitru-javamagic.rhcloud.com/MyFinance/queryBrowser.jsp">http://amitru-javamagic.rhcloud.com/MyFinance/queryBrowser.jsp</a></li>
